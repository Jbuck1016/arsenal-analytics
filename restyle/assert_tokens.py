...
FAMILY = {
    ...
    "dashboard/index.html": "app",
    "dashboard/search.html": "app",
    "dashboard/glossary.html": "app",
    "dashboard/sequences.html": "app",
    "dashboard/insights.html": "app",
    "dashboard/guide.html": "app",
    "dashboard/methodology.html": "app",
    "dashboard/validation.html": "app",
    "dashboard/market-values.html": "app",
    "dashboard/model-lab.html": "editorial",
    "dashboard/model-review.html": "editorial",
    "dashboard/writing-lab.html": "editorial",
}
...
STATE = {
    ("app", "light"): set(),
    ("app", "dark"): {"dark"},
    ("editorial", "light"): {"fam-editorial"},
    ("editorial", "dark"): {"dark", "fam-editorial"},
    ("gate", "light"): set(),
    ("gate", "dark"): {"dark"},
}

...
- The migration SHA-256 snapshot passes for all 192 frozen live-history migrations plus sixteen applied repository-authored migrations. The executable checker is canonical; this sentence must be updated whenever another later migration is added.

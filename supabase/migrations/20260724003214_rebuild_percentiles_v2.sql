insert into public.metric_defs (key,label,grp,unit,higher_is_better,definition,grp_order,sort_order)
values ('blocked_90','Shots blocked','Shooting',null,false,'His own shots blocked by a defender, per 90. The provider files these as saves, but they never reached the keeper.',3,13)
on conflict (key) do nothing;
update public.metric_defs
set definition='On-target shots per 90. Blocked attempts are excluded: the provider logs them as saves, but they never reach the keeper.'
where key='sot_90';
...
long as (
  ...
  cross join lateral (values
    ...
    ('shots_90',b.shots_90),('sot_90',b.sot_90),('goals_90',b.goals_90),('blocked_90',b.blocked_90),

...
begin
  ...
  -- 1) standout profile (percentile-based, skew-robust): player tops their pool for a role
  ...
  select 'sd','squad_gap','team', team, team, team, 'squad_gap',
    ...
    format('Their strongest %s profile sits at z %s within pool, below average. A clear recruitment lane.',
      role, round(best_z::numeric,1)),

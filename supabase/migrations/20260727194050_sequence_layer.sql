...
create index if not exists sequences_game_idx on public.sequences (game_id);
create index if not exists sequences_team_op_idx on public.sequences (team, is_open_play);

...
alter table public.sequences
  ...
  add column if not exists cx numeric,
  add column if not exists cy numeric,
  add column if not exists minx numeric,
  add column if not exists maxx numeric,
  add column if not exists miny numeric,
  add column if not exists maxy numeric,
  add column if not exists att_share numeric;

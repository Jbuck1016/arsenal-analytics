-- =====================================================================
-- 20260824_04_scope_view_entry_objects.sql
-- Stage 3, migration 04. APPLIED 2026-08-24. Requires 01, 02, 03.
--
-- NON-DESTRUCTIVE. Two league-mart entry objects are views, so they are
-- replaced in place with CREATE OR REPLACE VIEW. Dependent materialized
-- views pick the change up on their next refresh, with no drop and no
-- cascade. This removes cup contamination from the team evidence base
-- and the insight generator without any destructive operation.
--
-- v_team_sample previously derived league as min(s.league) across ALL
-- competitions, which resolved Arsenal to ENG-FA Cup and gave it a
-- 54-match cross-competition evidence base.
-- =====================================================================
begin;
